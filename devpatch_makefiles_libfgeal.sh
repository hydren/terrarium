...
./touch_makefiles.sh ./build/others/linux-gcc-libfgeal-release/ ${PWD} BUILD_PATH
echo "- Replacing current fgeal include folder with generic FGEAL_INCLUDE_PATH token..."
./touch_makefiles.sh ./build/others/linux-gcc-libfgeal-release/ $1 FGEAL_INCLUDE_PATH
